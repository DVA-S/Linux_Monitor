...
function runDisk(){
    xmlHttpDiskTime = pgGet("http://127.0.0.1/php/panel/disk.php?type=datatime&username="+getCookie("UserName")+"&token="+getCookie("Token"),diskback);
    xmlHttpDiskWrite = pgGet("http://127.0.0.1/php/panel/disk.php?type=diskwrite&username="+getCookie("UserName")+"&token="+getCookie("Token"),diskback);
    xmlHttpDiskRead = pgGet("http://127.0.0.1/php/panel/disk.php?type=diskread&username="+getCookie("UserName")+"&token="+getCookie("Token"),diskback);
}
function diskback(){
