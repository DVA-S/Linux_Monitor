...
function runMemory(){
    xmlHttpMemoryTime= pgGet("http://127.0.0.1/php/panel/memory.php?type=datatime&username="+getCookie("UserName")+"&token="+getCookie("Token"),memoryback);
    xmlHttpMemoryUsed = pgGet("http://127.0.0.1/php/panel/memory.php?type=memused&username="+getCookie("UserName")+"&token="+getCookie("Token"),memoryback);
    xmlHttpMemoryFree= pgGet("http://127.0.0.1/php/panel/memory.php?type=memfree&username="+getCookie("UserName")+"&token="+getCookie("Token"),memoryback);
}
function memoryback() {
