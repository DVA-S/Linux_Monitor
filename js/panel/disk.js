...
function runDisk(){
    xmlHttpDiskTime = pgGet("http://192.168.157.128/php/panel/disk.php?type=datatime&username="+getCookie("UserName")+"&token="+getCookie("Token"),diskback);
    xmlHttpDiskWrite = pgGet("http://192.168.157.128/php/panel/disk.php?type=diskwrite&username="+getCookie("UserName")+"&token="+getCookie("Token"),diskback);
    xmlHttpDiskRead = pgGet("http://192.168.157.128/php/panel/disk.php?type=diskread&username="+getCookie("UserName")+"&token="+getCookie("Token"),diskback);
}
function diskback(){
